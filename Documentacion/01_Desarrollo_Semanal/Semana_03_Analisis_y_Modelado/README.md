...
> Tamaño estimado (sistema medio): 3 actores → **~8 casos de uso**. ✔️

## 3. Diagramas (insertar en `04_Recursos/imagenes/` y referenciar)
| Diagrama | Estado | Archivo |
|---|:--:|---|
| Casos de uso (general) | ☐ | `../../04_Recursos/imagenes/[…]` |
| Actividad (flujo de cotización con swimlanes) | ☐ | `../../04_Recursos/imagenes/[…]` |
| Secuencia (validar RUC → cotizar → enviar) | ☐ | `../../04_Recursos/imagenes/[…]` |
| Clases del dominio | ☐ | `../../04_Recursos/imagenes/[…]` |
